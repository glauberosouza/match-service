...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.MOCK, classes = MatchServiceApplication.class)
...
public class BaseCompTest {
    ...
    void initDB() {
        ...
        databaseSeeder
                .addScript(new ClassPathResource("db.sql/insert_into_product.sql"));
